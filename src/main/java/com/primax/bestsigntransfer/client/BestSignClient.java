package com.primax.bestsigntransfer.client;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.primax.bestsigntransfer.sign.MD5Utils;
import com.primax.bestsigntransfer.sign.RSAUtils;
import okhttp3.*;
    ...
    private String executeRequest(String uriWithParam, String method, Object requestData, int retryTime) {
        while (retryTime > 0) {
            try {
                ...
                /**
                 *okHttpClient实例化SSLSocketFactory,X509TrustManager
                 */
